                    ...
                    <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                {/* Render Nav Links from navconfig */}
                                {navconfig.navLinks.map((link, index) => (
                                    <NavLink
                                        ...
                                        exact={link.exact}
                                        className={({ isActive }) => `px-3 py-2 text-sm font-medium rounded-md ${isActive ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`}
                                    >
                                        {link.name}
                                    </NavLink>
                                ))}
